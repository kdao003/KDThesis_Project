...
#Turn into a shapviz object
#*Uses shapviz package*
shap_viz <- shapviz(explainer)

#Visualize Shap Data
sv_importance(shap_viz, kind = "bee")
sv_dependence(shap_viz, v = "Inflammation_Scores")

# Plot ROC curve
preds_numeric <- as.numeric(preds) 
